...
size_block = 150
margin = 10
width = heidht = size_block * 3 + margin * 4

size_window = (width, heidht)
...
while True:
    ...
    for row in range(3):
        for col in range(3):
            ...
            if color == red:
                pygame.draw.line(screen, white, (x + 5, y + 5), (x + size_block - 5, y + size_block), 3)
    ...
    if game_over:
        screen.fill(black)
        font = pygame.font.SysFont('timesnewromanbold.ttf', 90)
